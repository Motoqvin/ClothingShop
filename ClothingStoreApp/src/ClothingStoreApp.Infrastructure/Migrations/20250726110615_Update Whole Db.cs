...
{
    /// <inheritdoc />
    public partial class UpdateWholeDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MethodTypeName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MethodTypes", x => x.MethodId);
                });
            ...
            migrationBuilder.InsertData(
                table: "MethodTypes",
                columns: new[] { "MethodId", "MethodTypeName" },
                values: new object[,]
                {
                    { 1, "GET" },
                    { 2, "POST" },
